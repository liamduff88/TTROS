...
> Revisit: when fit_call_prep SKILL.md changes. · Last touched: 2026-07-07.
...
- **Allowed unprompted** = read Business Brain prospect entity page, read public web signals, draft.
...
4. Update prospect entity page — sourced facts only.
