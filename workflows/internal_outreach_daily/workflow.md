...
> Revisit: after first 3 real runs; when `business_brain:memory/ideal_clients.md` or the LinkedIn lane split changes. · Last touched: 2026-07-15
...
Allowed unprompted = reading `business_brain:memory/ideal_clients.md`, `business_brain:memory/positioning.md`, `business_brain:memory/offers.md`; public-signal search; scoring; invoking `linkedin_outreach_prep` as a chained step with the named, evidenced output.
