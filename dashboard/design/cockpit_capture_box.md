...
> Revisit: if the canonical inbox or dashboard write path changes. · Last touched: 2026-07-20
...
- Target: `business_brain:inbox/source_notes/capture_<capture hash>.md`.
